...
if __name__ == '__main__':
    ...
    # Show Image
    for i, imgf in enumerate(list_img_files('mask_imgs')):
        img = imread(imgf)
        save_path = os.path.join('mask_imgs', str(i) + '_color.png')
        imshow(img, title=None, axes=False, colorbar=False, show=False, save_path=save_path)
